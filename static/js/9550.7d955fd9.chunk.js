"use strict";(self.webpackChunkassblasterdex_interface=self.webpackChunkassblasterdex_interface||[]).push([[9550],{55625:function(e,t,i){i.r(t),i.d(t,{default:function(){return ws}});var n=i(42893),s=i(12204),a=i(19903),o=i(80815),r=i(66196),d=i(93622),c=i(60198),l=i(11428),p=i(60476),h=i(2304),m=i(95202),x=i(46217),u=i(4572),g=i(30476),f=i(55867),w=i(14031),j=i(13712),y=i(50595),C=i(34578),_=i(87253),b=i(1990),P=i(39839),I=i(437),S=i(57482);const k=(0,_.default)(p.ZP).withConfig({displayName:"BelowFloorWarningModal__ModalWrapper",componentId:"sc-2aa83e4c-0"})`
  position: fixed;
  left: 50%;
  top: 50%;
...
`,Ke=(0,_.default)(Ee.SA).withConfig({displayName:"ContentRow__StyledVerifiedIcon",componentId:"sc-ac4ccdd6-8"})`
  ...
  width: 16px;
  margin-left: 4px;
`,qe=_.default.div.withConfig({displayName:"ContentRow__IconWrapper",componentId:"sc-ac4ccdd6-9"})`
  margin-left: auto;
  margin-right: 0px;
`,Ue=(0,_.default)(h.ZP).withConfig({displayName:"ContentRow__ButtonRow",componentId:"sc-ac4ccdd6-10"})`
  padding: 0px 16px;
  justify-content: space-between;
`,Qe=_.css`
  width: 152px;
...
`,tt=_.default.button.withConfig({displayName:"ContentRow__RetryButton",componentId:"sc-ac4ccdd6-12"})`
  ...
  color: ${({theme:e})=>e.neutral1};
  ${Qe}
`,it=({row:e,isCollectionApprovalSection:t,removeRow:i})=>{const a=(0,_.useTheme)(),o=(0,j.useRef)(),r=e.status===q.Sb.FAILED||e.status===q.Sb.REJECTED;return(0,j.useEffect)((()=>{e.status===q.Sb.SIGNING&&o.current}),[e.status]),(0,n.jsxs)(Be,{failed:r,children:[(0,n.jsxs)(Ge,{active:e.status===q.Sb.SIGNING||e.status===q.Sb.APPROVED,failed:r,ref:o,children:[t?(0,n.jsx)(He,{src:e.image}):(0,n.jsx)(ze,{src:e.image}),(0,n.jsx)(Ve,{children:(0,Oe.Dp)(e.marketplace.name,"24")}),(0,n.jsx)(Xe,{children:e.name}),t&&e.isVerified&&(0,n.jsx)(Ke,{}),(0,n.jsx)(qe,{children:e.status===q.Sb.DEFINED||e.status===q.Sb.PENDING?(0,n.jsx)(Fe.ZP,{height:"14px",width:"14px",stroke:e.status===q.Sb.PENDING?a.accent1:a.neutral3}):e.status===q.Sb.SIGNING?(0,n.jsx)(Ye,{children:(0,n.jsx)(s.cC,{id:"CpEYLQ"})}):e.status===q.Sb.APPROVED?(0,n.jsx)(De.Z,{height:"20",width:"20",stroke:a.success}):r&&(0,n.jsxs)(h.ZP,{children:[(0,n.jsx)(We.Z,{height:"20",width:"20",color:a.critical}),(0,n.jsx)(Je,{children:e.status===q.Sb.FAILED?(0,n.jsx)(s.cC,{id:"7Bj3x9"}):(0,n.jsx)(s.cC,{id:"ekCRTP"})})]})})]}),r&&(0,n.jsxs)(Ue,{justify:"space-between",children:[(0,n.jsx)(et,{onClick:()=>i(e),children:(0,n.jsx)(s.cC,{id:"t/YqKh"})}),(0,n.jsx)(tt,{onClick:e.callback,children:(0,n.jsx)(s.cC,{id:"6gRgw8"})})]})]})},nt=(0,_.default)(h.ZP).withConfig({displayName:"ListModalSection__SectionHeader",componentId:"sc-fe36f725-0"})`
  justify-content: space-between;
...
`,qt=(0,_.default)(D).withConfig({displayName:"MarketplaceRow__RemoveMarketplaceWrap",componentId:"sc-dd36ece7-2"})`
  top: 8px;
  left: 16px;
  z-index: 3;
`,Ut=(0,_.default)(h.ZP).withConfig({displayName:"MarketplaceRow__MarketIconsWrapper",componentId:"sc-dd36ece7-3"})`
  position: relative;
  margin-right: 12px;
  width: 44px;
  justify-content: flex-end;
...
`,Ki=(0,_.default)(Ei.X2).withConfig({displayName:"SetDurationModal__ErrorMessage",componentId:"sc-b747ba68-5"})`
  ...
  top: 44px;
  white-space: nowrap;
`,qi=(0,_.default)(C.Z).withConfig({displayName:"SetDurationModal__WarningIcon",componentId:"sc-b747ba68-6"})`
  width: 16px;
  color: ${({theme:e})=>e.critical};
`;var Ui,Qi;!function(e){e.hour="hour",e.day="day",e.week="week",e.month="month"}(Ui||(Ui={})),function(e){e[e.valid=0]="valid",e[e.empty=1]="empty",e[e.overMax=2]="overMax"}(Qi||(Qi={}));const en=()=>{const[e,t]=(0,j.useState)(Ui.day),[i,a]=(0,j.useState)("7"),[o,r]=(0,j.useState)(Qi.valid),d=(0,L.Pc)((e=>e.setGlobalExpiration)),[c,l]=(0,j.useReducer)((e=>!e),!1),p=(0,j.useRef)(null);(0,_t.t)(p,c?l:void 0);const h=(0,j.useMemo)((()=>[{displayText:"hours",isSelected:e===Ui.hour,onClick:()=>{t(Ui.hour),l()}},{displayText:"days",isSelected:e===Ui.day,onClick:()=>{t(Ui.day),l()}},{displayText:"weeks",isSelected:e===Ui.week,onClick:()=>{t(Ui.week),l()}},{displayText:"months",isSelected:e===Ui.month,onClick:()=>{t(Ui.month),l()}}]),[e]);let m;switch(e){case Ui.hour:m=(0,n.jsx)(s.cC,{id:"JC1A6G",values:{amount:i}});break;case Ui.day:m=(0,n.jsx)(s.cC,{id:"/TUNHz",values:{amount:i}});break;case Ui.week:m=(0,n.jsx)(s.cC,{id:"v3mlu/",values:{amount:i}});break;case Ui.month:m=(0,n.jsx)(s.cC,{id:"zo+8I3",values:{amount:i}})}return(0,j.useEffect)((()=>{const t=tn(parseFloat(i),e);1e3*t-Date.now()<O()("60s")||isNaN(t)?r(Qi.empty):1e3*t-Date.now()>O()("180d")?r(Qi.overMax):r(Qi.valid),d(t)}),[i,e,d]),(0,n.jsxs)(zi,{ref:p,children:[(0,n.jsxs)(Vi,{isInvalid:o!==Qi.valid,children:[(0,n.jsx)(vt.A,{as:"input",type:"number",pattern:"[0-9]",borderStyle:"none",className:Tt.d1,color:{placeholder:"neutral2",default:"neutral1"},value:i,width:"40",marginRight:"4",backgroundColor:"none",onChange:e=>{a(e.target.value.length?e.target.value:"")},flexShrink:"0"}),(0,n.jsxs)(Xi,{onClick:l,children:[m," ",(0,n.jsx)(Yi,{isOpen:c})]}),c&&(0,n.jsx)(Ji,{children:(0,n.jsx)(St,{dropDownOptions:h,width:125})})]}),o!==Qi.valid&&(0,n.jsxs)(Ki,{className:Tt.VJ,children:[" ",(0,n.jsx)(qi,{})," ",o===Qi.overMax?"Maximum 6 months":"Set duration"]})]})},tn=(e,t)=>Math.round((Date.now()+O()("1h")*(()=>{switch(t){case Ui.hour:return 1;case Ui.day:return 24;case Ui.week:return 168;default:return 720}})()*e)/1e3),nn=(0,_.default)(p.ZP).withConfig({displayName:"ListPage__ListingHeader",componentId:"sc-f59cdf59-0"})`
  gap: 16px;
  margin-top: 36px;
