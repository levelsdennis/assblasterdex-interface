"use strict";(self.webpackChunkassblasterdex_interface=self.webpackChunkassblasterdex_interface||[]).push([[9779],{63548:function(e,n,t){t.d(n,{Z:function(){return W}});var r=t(42893),i=t(12204),o=t(19903),a=t(80815),s=t(66196),c=t(13119),d=t(92483),l=t(48141),u=t(40508),p=t(13712),m=t(87253),h=t(39839),f=t(47371),b=t(57482),y=t(44326),g=t(42881),x=t(60198),v=t(45533),w=t(56823),C=t(48972),N=t(2304),_=t(86024),I=t(925);const j=m.default.div.withConfig({displayName:"CurrencyInputPanel__InputPanel",componentId:"sc-3db49bc3-0"})`
  ${f.lt};
  position: relative;
...
`,A=m.default.span.withConfig({displayName:"CurrencyInputPanel__Aligner",componentId:"sc-3db49bc3-6"})`
  ...
  width: 100%;
  line-height: 0px;
`,E=(0,m.default)(y.r).withConfig({displayName:"CurrencyInputPanel__StyledDropDown",componentId:"sc-3db49bc3-7"})`
...
`;function W({value:e,onUserInput:n,onMax:t,showMaxButton:d,onCurrencySelect:u,currency:f,otherCurrency:y,id:x,showCommonBases:C,showCurrencyAmount:P,disableNonToken:W,renderBalance:M,fiatValue:U,hideBalance:z=!1,pair:V=null,hideInput:G=!1,locked:L=!1,loading:Z=!1,...q}){const[F,K]=(0,p.useState)(!1),{account:H,chainId:X}=(0,a.useWeb3React)(),J=(0,g._h)(H??void 0,f??void 0),Q=(0,m.useTheme)(),{formatCurrencyAmount:Y}=(0,b.Gb)(),ee=(0,p.useCallback)((()=>{K(!1)}),[K]),ne=(0,l.EC)(X);return(0,r.jsxs)(j,{id:x,hideInput:G,...q,children:[!L&&(0,r.jsx)(r.Fragment,{children:(0,r.jsxs)(k,{hideInput:G,disabled:!ne,children:[(0,r.jsxs)(T,{style:G?{padding:"0",borderRadius:"8px"}:{},selected:!u,children:[!G&&(0,r.jsx)(D,{className:"token-amount-input",value:e,onUserInput:n,disabled:!ne,$loading:Z}),(0,r.jsx)(B,{shouldFetchOnAccountUpdate:F,$fullWidth:G,children:(0,r.jsx)($,{disabled:!ne,visible:void 0!==f,selected:!!f,hideInput:G,className:"open-currency-select-button",onClick:()=>{u&&K(!0)},pointerEvents:u?void 0:"none",children:(0,r.jsxs)(A,{children:[(0,r.jsxs)(N.DA,{children:[V?(0,r.jsx)("span",{style:{marginRight:"0.5rem"},children:(0,r.jsx)(v.Z,{currency0:V.token0,currency1:V.token1,size:24,margin:!0})}):f&&(0,r.jsx)(w.Z,{style:{marginRight:"0.5rem"},currency:f,size:"24px"}),V?(0,r.jsxs)(S,{className:"pair-name-container",children:[V?.token0.symbol,":",V?.token1.symbol]}):(0,r.jsx)(S,{className:"token-symbol-container",active:Boolean(f&&f.symbol),children:(f&&f.symbol&&f.symbol.length>20?f.symbol.slice(0,4)+"..."+f.symbol.slice(f.symbol.length-5,f.symbol.length):f?.symbol)||(0,r.jsx)(i.cC,{id:"T0Y2+3"})})]}),u&&(0,r.jsx)(E,{selected:!!f})]})})})]}),Boolean(!G&&!z&&f)&&(0,r.jsx)(O,{children:(0,r.jsxs)(N.m0,{children:[(0,r.jsx)(c.EG,{$loading:Z,children:U&&(0,r.jsx)(I.x,{fiatValue:U})}),H&&(0,r.jsxs)(N.DA,{style:{height:"17px"},children:[(0,r.jsx)(h.Tv.DeprecatedBody,{onClick:t,color:Q.neutral3,fontWeight:535,fontSize:14,style:{display:"inline",cursor:"pointer"},children:Boolean(!z&&f&&J)&&(M?.(J)||(0,r.jsx)(i.cC,{id:"VuFd5C",values:{0:Y({amount:J,type:b.sw.TokenNonTx})}}))}),Boolean(d&&J)&&(0,r.jsx)(s.M8,{events:[o.TM.onClick],name:o.Q0.SWAP_MAX_TOKEN_AMOUNT_SELECTED,element:o.xo.MAX_TOKEN_AMOUNT_BUTTON,children:(0,r.jsx)(R,{onClick:t,children:(0,r.jsx)(i.cC,{id:"4HtGBb"})})})]})]})})]})}),u&&(0,r.jsx)(_.Z,{isOpen:F,onDismiss:ee,onCurrencySelect:u,selectedCurrency:f,otherSelectedCurrency:y,showCommonBases:C,showCurrencyAmount:P,disableNonToken:W})]})}},4987:function(e,n,t){t.d(n,{q:function(){return C},w:function(){return _}});var r=t(42893),i=t(12204),o=t(80815),a=t(8713),s=t(46591),c=t(41440),d=t(80657),l=t(47096),u=t(63498),p=t(40740),m=t(4292),h=t(87253),f=t(39839),b=t(47371),y=t(2304);const g=h.default.div.withConfig({displayName:"NavigationTabs__Tabs",componentId:"sc-1056be7d-0"})`
  ${b.MG};
  align-items: center;
  border-radius: 3rem;
...
`,w=(0,h.default)(s.Z).withConfig({displayName:"NavigationTabs__StyledArrowLeft",componentId:"sc-1056be7d-3"})`
  color: ${({theme:e})=>e.neutral1};
`;function C({origin:e}){return(0,r.jsx)(g,{children:(0,r.jsxs)(y.m0,{style:{padding:"1rem 1rem 0 1rem",position:"relative"},children:[(0,r.jsx)(c.rU,{to:e,children:(0,r.jsx)(w,{})}),(0,r.jsx)(v,{children:(0,r.jsx)(i.cC,{id:"LCFvJr"})})]})})}const N=(0,h.default)(f.Tv.SubHeaderLarge).withConfig({displayName:"NavigationTabs__AddRemoveTitleText",componentId:"sc-1056be7d-4"})`
  flex: 1;
  margin: auto;
`;function _({adding:e,creating:n,autoSlippage:t,positionID:s,children:c}){const{chainId:f}=(0,o.useWeb3React)(),b=(0,h.useTheme)(),v=(0,u.T)(),C=(0,d.TH)().pathname.includes("add/v2")?"/pools/v2":"/pools"+(s?`/${s.toString()}`:"");return(0,r.jsx)(g,{children:(0,r.jsxs)(y.m0,{style:{padding:"1rem 1rem 0 1rem"},align:"center",children:[(0,r.jsx)(x,{to:C,onClick:()=>{e&&(v((0,p.dA)()),v((0,m.dA)()))},flex:c?"1":void 0,children:(0,r.jsx)(w,{stroke:b.neutral2})}),(0,r.jsx)(N,{textAlign:c?"start":"center",children:n?(0,r.jsx)(i.cC,{id:"ma87bD"}):e?(0,r.jsx)(i.cC,{id:"E6MqGy"}):(0,r.jsx)(i.cC,{id:"cJtosk"})}),c&&(0,r.jsx)(l.xu,{style:{marginRight:".5rem"},children:c}),(0,r.jsx)(a.Z,{autoSlippage:t,chainId:f,hideRoutingSettings:!0})]})})}},48244:function(e,n,t){t.d(n,{U:function(){return r},q:function(){return y}});var r,i=t(75255),o=t(19903),a=t(80815),s=t(66196),c=t(36665),d=t(5976),l=t(15337),u=t(13712),p=t(54479);function m(e,n,t){const{chainId:m}=(0,a.useWeb3React)(),h=e?.currency?.isToken?e.currency:void 0,f=function(e,n,t){const{account:i}=(0,a.useWeb3React)(),o=e?.currency?.isToken?e.currency:void 0,{tokenAllowance:s}=(0,d.Fx)(o,i??void 0,n),c=t(o,n);return(0,u.useMemo)((()=>e&&n?e.currency.isNative?r.APPROVED:s?s.lessThan(e)?c?r.PENDING:r.NOT_APPROVED:r.APPROVED:r.UNKNOWN:r.UNKNOWN),[e,c,n,s])}(e,n,t),b=(0,c.Ib)(h?.address),y=(0,u.useCallback)((async()=>{function t(e){console.warn(`${h?.symbol||"Token"} approval failed:`,e)}if(f!==r.NOT_APPROVED)return t("approve was called unnecessarily");if(!m)return t("no chainId");if(!h)return t("no token");if(!b)return t("tokenContract is null");if(!e)return t("missing amount to approve");if(!n)return t("no spender");let a=!1;const c=await b.estimateGas.approve(n,i.Bz).catch((()=>(a=!0,b.estimateGas.approve(n,e.quotient.toString()))));return b.approve(n,a?e.quotient.toString():i.Bz,{gasLimit:(0,p.y)(c)}).then((t=>{const r={chain_id:m,token_symbol:h?.symbol,token_address:(0,l.DT)(h)};return(0,s._P)(o.Je.APPROVE_TOKEN_TXN_SUBMITTED,r),{response:t,tokenAddress:h.address,spenderAddress:n,amount:e}})).catch((e=>{throw t(e),e}))}),[f,h,b,e,n,m]);return[f,y]}!function(e){e.UNKNOWN="UNKNOWN",e.NOT_APPROVED="NOT_APPROVED",e.PENDING="PENDING",e.APPROVED="APPROVED"}(r||(r={}));var h=t(97905),f=t(843);function b(e){const n=(0,h.h7)();return(0,u.useCallback)((()=>e().then((e=>{if(e){const{response:t,tokenAddress:r,spenderAddress:i,amount:o}=e;n(t,{type:f.i.APPROVAL,tokenAddress:r,spender:i,amount:o.quotient.toString()})}}))),[n,e])}function y(e,n){const[t,r]=m(e,n,h.wB);return[t,b(r)]}},72714:function(e,n,t){t.d(n,{Z:function(){return s},e:function(){return a}});var r=t(42893),i=t(87253),o=t(437);const a=i.default.main.withConfig({displayName:"AppBody__BodyWrapper",componentId:"sc-e9d30a3e-0"})`
  position: relative;
...
//# sourceMappingURL=9779.9f7a5e21.chunk.js.map