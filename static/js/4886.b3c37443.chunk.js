...
`,S=(0,w.default)(x.Tv.DeprecatedSmall).withConfig({displayName:"Polling__StyledPollingBlockNumber",componentId:"sc-1647183e-1"})`
...
`,B=w.default.div.withConfig({displayName:"Polling__StyledPollingDot",componentId:"sc-1647183e-2"})`
  width: 8px;
  height: 8px;
  min-height: 8px;
  min-width: 8px;
...
`,St=w.default.a.withConfig({displayName:"AirdropModal__LinkWrap",componentId:"sc-2e5fa0a7-4"})`
  text-decoration: none;
  ${bt.c}
`,Bt=w.default.div.withConfig({displayName:"AirdropModal__ImageContainer",componentId:"sc-2e5fa0a7-5"})`
  position: relative;
  width: 100%;
