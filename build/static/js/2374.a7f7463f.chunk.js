"use strict";(self.webpackChunkassblasterdex_interface=self.webpackChunkassblasterdex_interface||[]).push([[2374,9111],{4987:function(e,n,t){t.d(n,{q:function(){return C},w:function(){return k}});var i=t(42893),r=t(12204),a=t(80815),o=t(8713),c=t(46591),s=t(41440),d=t(80657),l=t(47096),u=t(63498),x=t(40740),p=t(4292),h=t(87253),m=t(39839),g=t(47371),f=t(2304);const y=h.default.div.withConfig({displayName:"NavigationTabs__Tabs",componentId:"sc-1056be7d-0"})`
  ${g.MG};
  align-items: center;
  border-radius: 3rem;
...
`,u=i.default.span.withConfig({displayName:"styled__CardNoise",componentId:"sc-6a13bc9-3"})`
  ...
  left: 0;
  user-select: none;
`,x=(0,i.default)(c.Tz).withConfig({displayName:"styled__CardSection",componentId:"sc-6a13bc9-4"})`
  padding: 1rem;
  z-index: 1;
  opacity: ${({disabled:e})=>e&&"0.4"};
`,p=i.default.div.withConfig({displayName:"styled__Break",componentId:"sc-6a13bc9-5"})`
  width: 100%;
